# 📑 Understanding Administrative Units in Azure Entra ID
...
- **Granular Delegation:** Assign specific administrative roles to different segments of your organization.
