...
- you can use CloudFormation Template for creating that VPC.
...
2. **Create a Cluster**:
   ...
   - **Role**: Create an IAM role, This role allows AWS EKS to manage your AWS resources on your behalf.
