...
```bash
sudo ip netns exec $NODE2_NS1 iptables -t nat -A POSTROUTING -o br0 -j MASQUERADE
sudo ip netns exec $NODE2_NS2 iptables -t nat -A POSTROUTING -o br0 -j MASQUERADE
```
