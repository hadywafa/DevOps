...
```nginx
# Proxy traffic for hadywafa.com to Minikube Ingress
server {
    listen 80;
    server_name hadywafa.com;  # Replace with your domain

    location / {
        # Replace <30532> with your nginx controller NodePort and <192.168.49.2> with minikube IP
        proxy_pass http://192.168.49.2:30532;
