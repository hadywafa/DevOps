...
### **Install a Pod [Network Add-on](https://kubernetes.io/docs/concepts/extend-kubernetes/compute-storage-net/network-plugins/)**
...
## **7. Join Worker Nodes to the Cluster** (Worker Nodes Only)
...
## **8. Configure kubectl for the Default User** (Remote Node)
...
```bash
# paste the kubeconfig file content to the remote node
