...
- **Additional Info**: For certain rules, you might see additional criteria like `tcp dpt:22`, which specifies that the rule applies to TCP traffic destined for port 22.
